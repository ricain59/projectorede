...
public class ThreadClient extends JFrame implements Runnable{
	  ...
	  private 		BufferedReader 		_in; // pour gestioe du flux d'entr�e
	  private 		Serveur 			_Serveur; // pour ueilisation des m�thodes de la classe principale
	  private 		int 				_numClient=0; // centiendra le nue�eo de client g�r� par ce thread
	  boolean 		flag=false;
